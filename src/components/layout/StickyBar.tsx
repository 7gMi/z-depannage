...
export function StickyBar({ phoneLink }: { phoneLink: string }) {
  const { t } = useT();
  return (
    <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-50 flex items-center gap-3 bg-[var(--bg-dark)]/80 backdrop-blur-xl border border-white/10 rounded-2xl px-4 py-2.5 sm:px-4 sm:py-2.5 shadow-2xl">
      {/* Téléphone */}
      <a
        href={phoneLink}
      ...
      >
        ...
        <span className="hidden sm:inline">{t('aria.call')}</span>
      </a>
