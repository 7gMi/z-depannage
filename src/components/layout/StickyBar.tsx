...
export function StickyBar({ phoneLink, phoneDisplay }: { phoneLink: string; phoneDisplay: string }) {
  ...
  return (
    <>
      {/* Mobile : barre full width en bas avec CTA appel géant */}
      <div className="sm:hidden fixed bottom-0 left-0 right-0 z-50 bg-[var(--bg-dark)]/95 backdrop-blur-xl border-t border-white/10 px-3 py-2.5 shadow-2xl">
